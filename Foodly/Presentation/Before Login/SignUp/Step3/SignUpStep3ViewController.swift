...
class SignUpStep3ViewController: UIViewController, Coordinating {
    private let customView = SignUpStep3View()
    private let viewmodel = AppContainer.shared.resolve(SignUpStep3ViewModel.self)!
    ...
    private func navigateToHome() {
        coodinator?.eventOccurred(with: .signUpStep3Tapped)
    }
...
extension SignUpStep3ViewController: UITextFieldDelegate {
